...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post performances_url, params: { performance: { client_id: @performance.client_id, date: @performance.date, description: @performance.description, duration: @performance.duration, invoiced: @performance.invoiced, rate_id: @performance.rate_id } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { client_id: @performance.client_id, date: @performance.date, description: @performance.description, duration: @performance.duration, invoiced: @performance.invoiced, rate_id: @performance.rate_id } }
